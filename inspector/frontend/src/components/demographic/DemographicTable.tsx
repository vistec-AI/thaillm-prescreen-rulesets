...
export default function DemographicTable({ items, selectedQid, onSelect }: Props) {
  if (items.length === 0) {
    return <div className="text-center text-gray-400 py-8">No demographic fields loaded.</div>;
  }
