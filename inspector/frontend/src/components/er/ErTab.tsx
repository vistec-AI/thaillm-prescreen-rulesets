...
import { fetchErSymptoms, fetchErChecklist, updateErQuestion } from "@/lib/api/er";
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <div className="flex-1 grid grid-cols-1 md:grid-cols-[minmax(0,1fr)_320px] lg:grid-cols-[minmax(0,1fr)_380px] xl:grid-cols-[minmax(0,1fr)_420px] 2xl:grid-cols-[minmax(0,1fr)_480px] gap-3 min-h-0">
        <ErTable items={items} selectedQid={selected?.qid ?? null} onSelect={handleSelect} />
        ...
        <DetailsPanel>
          ...
          {!selected ? (
            ...
            <ErDetails item={selected} onEdit={handleEdit} />
          )}
        </DetailsPanel>
      </div>
    </div>
